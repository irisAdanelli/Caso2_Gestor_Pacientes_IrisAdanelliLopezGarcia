...
public class Detalle_Receta extends AppCompatActivity {
    ...
    private ArrayList<Cliente> clienteList2 = new ArrayList<Cliente>();
    private RecyclerView rcvWorkers, rcvDetalleTrabajadores;
    private ClienteAdapter adapter,adapterDetalle;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayoutManager layoutManager2 = new LinearLayoutManager(Detalle_Receta.this);
        ...
        adapterDetalle = new ClienteAdapter(this, clienteList2,this);
        LinearLayoutManager layoutManager = new LinearLayoutManager(Detalle_Receta.this);
        ...
        fetchWorkersRecords();
        fetchDetailsRecords();
        adapterDetalle.setOnItemClickListener(new ClienteAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(final int position) {
                //SE INFLA EL EDIT
                Toast.makeText(Detalle_Receta.this, "ssssssssss", Toast.LENGTH_SHORT).show();
                LayoutInflater inflater = getLayoutInflater();
                View mView1 = inflater.inflate(R.layout.detalle_edit,null);
                final BaseDatos dbFunctions = new BaseDatos(Detalle_Receta.this);
                ArrayList<Detalle> detalles = dbFunctions.getSingleDetail(Integer.parseInt(id), clienteList2.get(position).getIdTrabajador());
                ...
                _txtNombre.setText(clienteList2.get(position).getNombreTrabajador());
                _txtActividad.setText(clienteList2.get(position).getActividadTrabajador());
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(Detalle_Receta.this);
                ...
                final int idTrabajador = clienteList2.get(position).getIdTrabajador();
        ...
        adapter.setOnItemClickListener(new ClienteAdapter.OnItemClickListener() {
            ...
            public void onItemClick(final int position) {
                ...
                edtCantidad = mView1.findViewById(R.id.edtCantidad);
                edtPago = mView1.findViewById(R.id.edtPago);
                _txtNombre.setText(clienteList.get(position).getNombreTrabajador());
                _txtActividad.setText(clienteList.get(position).getActividadTrabajador());
                ...
                btnGuardar.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        int idTrabajador = clienteList.get(position).getIdTrabajador();
    ...
    private void Update(int idCl, int idTr, String fechIni, String fechFin, String cant, String pago) {
        try {
            BaseDatos dbfunctions = new BaseDatos(Detalle_Receta.this);
        ...
        try{
            ...
            if (data.size()>0){
                for (int i = 0; i<data.size(); i++){
                    ...
                    cliente.setIdTrabajador(id);
                    cliente.setNombreTrabajador(nombre);
                    cliente.setActividadTrabajador(actividad);
                    cliente.setCelularTrabajador(celular);
                ...
                Toast.makeText(Detalle_Receta.this, "No Records found.", Toast.LENGTH_SHORT).show();
            }
        }
        catch (Exception e){
